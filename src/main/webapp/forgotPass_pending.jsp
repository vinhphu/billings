...
<title>Forgot Password Pending</title>
...
<body class="hold-trasition login-page">
	<div class="login-box">
		...
		<div class="login-box-body">
			<p class="login-box-msg" style="font-size: 20px">Chúng tôi đã gửi
				Email cho bạn, vui lòng kiểm tra Email và làm theo hướng dẫn.</p>
